...
def build_sql(data):
    statements = [
        "-- Mock Open Finance MySQL seed data",
        "-- Generated by generate_mock_mysql_sql.py",
        "START TRANSACTION;\n",
        insert_statement(
            "users",
            [
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate MySQL INSERT seed data for OpenFinanceSchema.sql.")
